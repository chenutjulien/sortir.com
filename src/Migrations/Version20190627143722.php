...
final class Version20190627143722 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trip ADD end_date_time DATETIME NOT NULL, DROP duration');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trip ADD duration DOUBLE PRECISION NOT NULL, DROP end_date_time');
    }
}
