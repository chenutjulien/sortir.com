...
final class Version20190627073433 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tripback CHANGE organiser_id organiser_id INT NOT NULL, CHANGE state_id state_id INT NOT NULL, CHANGE spot_id spot_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE tripback CHANGE organiser_id organiser_id INT DEFAULT NULL, CHANGE state_id state_id INT DEFAULT NULL, CHANGE spot_id spot_id INT DEFAULT NULL');
    }
}
