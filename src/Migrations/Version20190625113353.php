 ...
 */
final class Version20190625113353 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trip (id INT AUTO_INCREMENT NOT NULL, organiser_id INT NOT NULL, state_id INT NOT NULL, spot_id INT NOT NULL, name VARCHAR(255) NOT NULL, start_date_time DATETIME NOT NULL, duration DOUBLE PRECISION NOT NULL, max_registration INT NOT NULL, informations LONGTEXT DEFAULT NULL, cancel_reason LONGTEXT DEFAULT NULL, INDEX IDX_7656F53BA0631C12 (organiser_id), INDEX IDX_7656F53B5D83CC1 (state_id), INDEX IDX_7656F53B2DF1D37C (spot_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
