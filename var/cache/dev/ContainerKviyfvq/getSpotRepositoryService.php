...
return $this->services['App\\Repository\\SpotRepository'] = new \App\Repository\SpotRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->getDoctrineService()) && false ?: '_'});
