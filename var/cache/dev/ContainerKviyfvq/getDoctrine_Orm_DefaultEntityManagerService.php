...
$a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['App\\Repository\\SiteRepository' => function () {
    return ${($_ = isset($this->services['App\\Repository\\SiteRepository']) ? $this->services['App\\Repository\\SiteRepository'] : $this->load('getSiteRepositoryService.php')) && false ?: '_'};
}, 'App\\Repository\\SpotRepository' => function () {
    return ${($_ = isset($this->services['App\\Repository\\SpotRepository']) ? $this->services['App\\Repository\\SpotRepository'] : $this->load('getSpotRepositoryService.php')) && false ?: '_'};
